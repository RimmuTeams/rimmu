	...
	<body>
		...
		<div id="wrapper">
			...
			<header id="header" class="container">
						...
						<li>
							<div class="btn-group">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="#"><span class="awe-money"></span> Make a Deposit</a></li>
									<li class="divider"></li>
									<li><a href="#"><span class="awe-flag"></span> Help</a></li>
									<li><a href="#"><span class="awe-pencil"></span> Make Money</a></li>
								</ul>
							</div>
						</li>
				...
				<!-- Main page logo -->
				<h1><a href="index.html" class="brand">Rimmu</a></h1>
				...
				<div class="navigation-block">
					...
					<section class="user-profile">
						<figure>
							...
							<figcaption>
								<strong><a href="#" class="">User Name</a></strong>
								<em>student</em>
								<ul>
									<li><a class="btn btn-danger btn-flat" data-toggle="modal" href="#notifModal" title="Notifications"><span class="awe-globe"> 1</span></a></li>
									<li><a class="btn btn-primary btn-flat" data-toggle="modal" href="#inboxModal" title="Message inbox"><span class="awe-envelope"></span> </a></li>
								</ul>
							</figcaption>
						</figure>
					</section>
					...
					<nav class="main-navigation nav-collapse collapse" role="navigation">
						<ul>
							<li class="current"><a href="index.html" class="no-submenu"><span class="awe-home"></span>Dashboard</a></li>
							<li><a href="tournament.html" class="no-submenu"><span class="awe-trophy"></span>Tournament</a></li>
							<li><a href="events.html" class="no-submenu"><span class="awe-bookmark"></span>Events</a></li>
							<li><a href="quiz.html" class="no-submenu"><span class="awe-edit"></span>Quiz</a></li>
							<li><a href="project.html" class="no-submenu"><span class="awe-cloud"></span>Project <span class="badge">1</span></a></li>
							<li><a href="course.html" class="no-submenu"><span class="awe-book"></span>Course <span class="badge">7</span></a></li>
							<li><a href="drive.html" class="no-submenu"><span class="awe-folder-close"></span>Drive</a></li>
		...
		<footer id="footer" class="container">
			...
			<ul>
				...
				<li><a href="#" class="">Policy & Safety</a></li>
				<li><a href="#" class="">Support</a></li>
				<li><a href="#" class="">Copyright</a></li>
				<li><a href="#" class="">Advertising</a></li>
				<li><a href="#" class="">Send feedback</a></li>
			</ul>
